...
class CenterNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _topMoveAnimation = AnimUtils.animate(
        animationController, Offset(0, 5), Offset(0, 0), 0.0, 0.2);
    final _loginTextMoveAnimation = AnimUtils.animate(
        animationController, Offset(0, 5), Offset(0, 0), 0.4, 0.6);
